...
if (!empty($sql_check)) {
	$query=mysqli_query($conn,"update  profiles set img='$img',name='$name',dob='$dob',number='$number',email='$email' ");
if ($query) {
...
echo "<h1>error</h1>";
  ...
  ?>
        ...
        <p class="lead">
          <a href="http://localhost/job_portal/my_profile.php" class="btn btn-lg btn-secondary">Profile</a>
        </p>
      </main>
